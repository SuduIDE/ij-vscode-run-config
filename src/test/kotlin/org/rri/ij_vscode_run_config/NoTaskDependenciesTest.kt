...
class NoTaskDependenciesTest : BaseImportTestCase() {
    ...
    fun testTasksDependencies() {
        ...
        importManager.importConfigurations(importManager.getConfigurationNames())

        assertEquals(16, runManager.allSettings.size)

        assertSameFileWithText(getXmlOutputMainTaskSuffix(""), getOutPath().resolve("Main_task$configFileNameSuffix.xml"), false)
        ...
        assertSameFileWithText(getXmlOutputParallel_3_Suffix(""), getOutPath().resolve("Parallel_3$configFileNameSuffix.xml"), false)
        ...
        assertSameFileWithText(getXmlOutputSequence_211_Suffix(""), getOutPath().resolve("Sequence_211$configFileNameSuffix.xml"), false)
